...
const fontStyle = css`
  ...
  @font-face {
    font-family: 'Pretendard';
    src:
      url('/src/styles/fonts/Pretendard-Light.ttf') format('truetype'),
  ...
  @font-face {
    font-family: 'Pretendard';
    src:
      url('/src/styles/fonts/Pretendard-Regular.ttf') format('truetype'),
  ...
  @font-face {
    font-family: 'Pretendard';
    src:
      url('/src/styles/fonts/Pretendard-Medium.ttf') format('truetype'),
  ...
  @font-face {
    font-family: 'Pretendard';
    src:
      url('/src/styles/fonts/Pretendard-SemiBold.ttf') format('truetype'),
