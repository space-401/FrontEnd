import type {AccountDataType, BookMarkListType, MyCommentListType, MyPostListType} from "@type/user.type";
...
export const myCommentList: MyCommentListType = {
  myCommentList: [{
    ...
    spaceTitle: 'space401',
    postTitle: '당신은 전문가',
    postContent: '블라디미르 푸틴 러시아 대통령이 김정은 북한 국무위원장에게 “당신은 전문가”라고 말하는 영상이 공개됐다.\n' +
        '러시아 국영방송 ‘로시야’의 파벨 자루빈 기자는 지난 15일(현지시각) 텔레그램에 ‘아직 아무도 본 적 없는 대화’라며 푸틴 대통령과 김 위원장의 미공개 영상을 올렸다. ...',
    commentContent: '헐 여기 전에 가본데 자너 여기 좋음;; 헐 여기 전에 가본데 자너 여기 좋음;; ',
