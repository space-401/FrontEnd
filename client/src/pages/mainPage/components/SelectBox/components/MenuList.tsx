...
import UserList from '@pages/MainPage/components/SelectBox/components/component/UserList';
import TagList from '@pages/MainPage/components/SelectBox/components/component/TagList';
