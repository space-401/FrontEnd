...
import {BasicIcon, BasicIconModal, ImageEditModal, SelectIconModal, TagEditModal,} from '@/components/Create';
...
const CreateSpace = () => {
    ...
    const formTitle = isUpdateForm ? SPACE_MESSAGE.TITLE.UPDATE : SPACE_MESSAGE.TITLE.CREATE;
